...
1. ~~Models-сторінка на 3080~~ — ВИРІШЕНО 2026-09-07 ввечері: прод рестартнуто
   через safe-restart (канарка PASS, PID 13756). Рядки "DeepSeek"/"DashScope (Qwen)"
   мають бути відсутні. УРОК: HMR підхоплює cordis.patch.yml наживо, але лишає
   напів-remountнутий стан — після зміни cordis.patch.yml треба ПОВНИЙ рестарт,
   інакше ходи падають з "Cannot read properties of undefined (reading 'prepare')".
