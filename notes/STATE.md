...
- 2026-09-07: провайдер **qwen-token-plan (DashScope) видалено** з settings.yaml обох інстансів + ключ QWEN_TOKEN_PLAN_API_KEY прибрано з .credentials.yaml; дефолтна модель dev змінена на openai-codex/gpt-5.5
